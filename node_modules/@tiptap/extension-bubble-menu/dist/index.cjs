...
var BubbleMenuView = class {
	...
	get virtualElement() {
		...
		if (selection instanceof _tiptap_pm_tables.CellSelection) {
	...
	constructor({ editor, element, view, pluginKey = "bubbleMenu", updateDelay = 250, resizeDelay = 60, shouldShow, appendTo, getReferencedVirtualElement, options }) {
		...
		this.shouldShow = ({ view, state, from, to }) => {
			...
			const isEmptyTextBlock = !doc.textBetween(from, to).length && (0, _tiptap_core.isTextSelection)(state.selection);
	...
	updatePosition() {
		...
		(0, _floating_ui_dom.computePosition)(virtualElement, this.element, {
...
*/
const BubbleMenu = _tiptap_core.Extension.create({
	name: "bubbleMenu",
	addOptions() {
		return {
			element: null,
